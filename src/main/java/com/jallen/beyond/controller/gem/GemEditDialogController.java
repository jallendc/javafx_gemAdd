...
public class GemEditDialogController {
    ...
    public void setGem(Gem gem) {
        ...
        gemNameField.setText(gem.getGemName());
        gemValueField.setText(Integer.toString(gem.getGemValue()));
        gemDescripField.setText(gem.getDescription());
    }
